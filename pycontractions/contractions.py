...
simple_contractions = {
    ...
    re.compile(r"\bya'?ll\b", re.I | re.U): "you all",
    re.compile(r"\by'?all\b", re.I | re.U): "you all",
    re.compile(r"\bya'?ll'?d\b", re.I | re.U): "you all would",
    re.compile(r"\by'?all'?d\b", re.I | re.U): "you all would",
    re.compile(r"\bya'?ll'?d'?ve\b", re.I | re.U): "you all would have",
    re.compile(r"\by'?all'?d'?ve\b", re.I | re.U): "you all would have",
    re.compile(r"\bya'?ll'?re\b", re.I | re.U): "you all are",
    re.compile(r"\by'?all'?re\b", re.I | re.U): "you all are",
    re.compile(r"\bya'?ll'?ve\b", re.I | re.U): "you all have",
...
contextual_contractions = {
    ...
    re.compile(r"\bI'll\b", re.I | re.U): ["I will", "I shall"],
    re.compile(r"\bI'?ll'?ve\b", re.I | re.U): ["I will have", "I shall have"],
    re.compile(r"\bit'?d\b", re.I | re.U): ["it had", "it would"],
    re.compile(r"\bit'?ll\b", re.I | re.U): ["it will", "it shall"],
    re.compile(r"\bit'?ll'?ve\b", re.I | re.U): ["it will have", "it shall have"],
    # Possessive form does not have apostrophe
    re.compile(r"\bit's\b", re.I | re.U): ["it is", "it has"],
    re.compile(r"\bshe'?d\b", re.I | re.U): ["she had", "she would"],
    re.compile(r"\bshe'll\b", re.I | re.U): ["she will", "she shall"],
    re.compile(r"\bshe'?ll'?ve\b", re.I | re.U): ["she will have", "she shall have"],
    re.compile(r"\bshe'?s\b", re.I | re.U): ["she is", "she has"],
    ...
    re.compile(r"\bthat'?s\b", re.I | re.U): ["that is", "that has"],
    re.compile(r"\bthere'?d\b", re.I | re.U): ["there would", "there had"],
    re.compile(r"\bthere'?s\b", re.I | re.U): ["there is", "there has"],
    re.compile(r"\bthey'?d\b", re.I | re.U): ["they would", "they had"],
    re.compile(r"\bthey'?ll\b", re.I | re.U): ["they will", "they shall"],
    re.compile(r"\bthey'?ll'?ve\b", re.I | re.U): ["they will have", "they shall have"],
    re.compile(r"\bwe'd\b", re.I | re.U): ["we would", "we had"],
    re.compile(r"\bwhat'?ll\b", re.I | re.U): ["what will", "what shall"],
    re.compile(r"\bwhat'?ll'?ve\b", re.I | re.U): ["what will have", "what shall have"],
    re.compile(r"\bwhat'?s\b", re.I | re.U): ["what is", "what has"],
    re.compile(r"\bwhen'?s\b", re.I | re.U): ["when is", "when has"],
    re.compile(r"\bwhere'?s\b", re.I | re.U): ["where is", "where has"],
    re.compile(r"\bwho'?ll\b", re.I | re.U): ["who will", "who shall"],
    re.compile(r"\bwho'?ll'?ve\b", re.I | re.U): ["who will have", "who shall have"],
    re.compile(r"\bwho'?s\b", re.I | re.U): ["who is", "who has"],
    re.compile(r"\bwhy'?s\b", re.I | re.U): ["why is", "why has"],
    re.compile(r"\byou'?d\b", re.I | re.U): ["you would", "you had"],
    re.compile(r"\byou'?ll\b", re.I | re.U): ["you will", "you shall"],
    re.compile(r"\byou'?ll'?ve\b", re.I | re.U): ["you will have", "you shall have"],
}
